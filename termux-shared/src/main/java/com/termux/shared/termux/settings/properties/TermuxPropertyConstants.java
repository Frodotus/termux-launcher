...
public final class TermuxPropertyConstants {
    ...
    public static final String KEY_APP_LAUNCHER_PINNED_APPS = "app-launcher-pinned-apps";
    ...
    KEY_BACK_KEY_BEHAVIOUR, KEY_DEFAULT_WORKING_DIRECTORY, KEY_EXTRA_KEYS, KEY_EXTRA_KEYS2, KEY_EXTRA_KEYS_STYLE, KEY_NIGHT_MODE, KEY_SOFT_KEYBOARD_TOGGLE_BEHAVIOUR, KEY_VOLUME_KEYS_BEHAVIOUR, KEY_BACKGROUND_OVERLAY_COLOR, KEY_APP_LAUNCHER_HIDDEN_APPS, KEY_APP_LAUNCHER_PINNED_APPS, KEY_APP_LAUNCHER_ALWAYS_SEARCH, KEY_APP_LAUNCHER_SEARCH_MODE, KEY_APP_LAUNCHER_INPUT_CHAR, /* int */
