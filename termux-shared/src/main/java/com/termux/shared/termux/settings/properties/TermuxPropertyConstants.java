...
public final class TermuxPropertyConstants {
    ...
    /**
     * Defines the key for powerline/private-use glyph baseline nudge in px.
     */
    // Default: "terminal-powerline-baseline-nudge"
    public static final String KEY_TERMINAL_POWERLINE_BASELINE_NUDGE = "terminal-powerline-baseline-nudge";

    public static final float IVALUE_TERMINAL_POWERLINE_BASELINE_NUDGE_MIN = -2f;

    public static final float IVALUE_TERMINAL_POWERLINE_BASELINE_NUDGE_MAX = 2f;

    public static final float DEFAULT_IVALUE_TERMINAL_POWERLINE_BASELINE_NUDGE = 0f;
    ...
    KEY_TERMINAL_TOOLBAR_HEIGHT_SCALE_FACTOR, KEY_TERMINAL_POWERLINE_BASELINE_NUDGE, /* Integer */
