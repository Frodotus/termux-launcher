...
public final class TermuxActivity extends AppCompatActivity implements ServiceConnection, SuggestionBarCallback {
    ...
    private void syncAzScrubLettersAndTint() {
        ...
        if (mLauncherAzGestureFxView != null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                mLauncherAzGestureFxView.setElevation(0f);
                mLauncherAzGestureFxView.setTranslationZ(-dpToPx(8));
            }
        }
    ...
    private void handleAzGestureScrub(
        ...
        if (mAzGestureMode == AzGestureMode.ICON_TRACKING_LOCKED || (phase == AzScrubRowView.GesturePhase.UP && touchY < 0f)) {
